...
describe('Flagger:', function () {
  ...
  it('should return flag details', function (done) {
    flagger(policy, [post], function (err, data) {
      ...
      flaggedPost.flags[0].loc[1].start.should.equal(4)
      flaggedPost.flags[0].loc[1].end.should.equal(10)
      flaggedPost.flags[0].loc[2].start.should.equal(20)
      flaggedPost.flags[0].loc[2].end.should.equal(23)
